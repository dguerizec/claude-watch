 ...
 * @param period_secs    Duration of one rotation in seconds
 * @param num_rotations  Number of historical rotations to display
 * @param num_ticks      Number of tick marks around the circle
 * @param period_end     Reset time — mapped to north (12 o'clock)
 * @param now            Current time (epoch) — for the "now" hand
 * @param recovery_angle Recovery time marker angle in radians (<0 = no marker)
 */
